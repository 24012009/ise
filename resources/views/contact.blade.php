...
@endsection
@section("content")
    <div class="container-fluid" style="padding-top:160.875px">
        <div class="container p-0 shadow rounded my-5">
            <div class="row">
                <div class="col-md-5">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3881.7313080482254!2d103.8505387!3d13.3669763!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x311017b26c02320f%3A0xa37e1f3ed4d1f9ee!2sInnovation%20School%20of%20Education!5e0!3m2!1skm!2skh!4v1605608314932!5m2!1skm!2skh" width="100%" height="575" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
                </div>
                <div class="col-md-7">
                    <form class="pl-4 pr-5 py-5">
                        <div class="form-row">
                            <div class="col-md-12">
                                <h3 class="text-center py-3 text-primary">Get in touch</h3>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputEmail4" class="text-primary font-weight-normal">Name</label>
                            {!! Form::text("name",null,["class"=>"form-control"]) !!}
                        </div>
                        <div class="form-group">
                            <label for="email" class="text-primary font-weight-normal">Email</label>
                            {!! Form::text("email",null,["class"=>"form-control"]) !!}
                        </div>
                        <div class="form-group">
                            <label for="subject" class="text-primary font-weight-normal">Subject</label>
                            {!! Form::text("subject",null,["class"=>"form-control"]) !!}
                        </div>
                        <div class="form-group">
                            <label for="review" class="text-primary font-weight-normal">Review</label>
