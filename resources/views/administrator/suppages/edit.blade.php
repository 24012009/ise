...
@section('content')
    {!! Form::open(array('url' =>"administrator/subpages/edit/{$id}",'method'=>'PUT','files' => true)) !!}
    <div class="row">
        <div class="col-md-8">
                        ...
                        <div class="col-lg-12 margin-tb">
                            <div class="pull-right">
                                <a
                                    ...
                                    href="{{ url("administrator/subpages") }}">
                    ...
                    <div class="row">
                        <div class="col-xs-6 col-sm-6 col-md-6">
                            <div class="form-group">
                                ...
                                {!! Form::select('sl_pages',$pages,$sub->page_id, array('class' =>'form-control')) !!}
                            </div>
                        </div>
                        <div class="col-xs-6 col-sm-6 col-md-6">
                            <div class="form-group">
                                <label>Sub page title</label>
                                {!! Form::text('title_subpage',$sub->title_subpage, array('placeholder' => 'Name','class' =>'form-control')) !!}
                            </div>
                        </div>
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-6">
                            <div class="form-group">
                                <label>Links</label>
                                {!! Form::text('links',$sub->links, array('placeholder' => 'URL','class' =>'form-control')) !!}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="accordion accordion-secondary" id="accordionExample">
                        <div class="card mb-0 border rounded-0">
                            <div class="card-header1 p-2" id="headingOne">
                                <h2 class="mb-0">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="is_active" class="form-control">
                                                <option value="1" {{($sub->is_active==1)?"selected":""}}>Active</option>
                                                <option value="0" {{($sub->is_active==0)?"selected":""}}>Inactive</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            {!! Form::text('order_by',$sub->order_by, array('class' =>'form-control','required'=>'')) !!}
                                        </div>
                                    </div>
                                </div>
                            </div>
