                    ...
                    @foreach($section->columns as $i=>$rows)
                        <div class="col-xs-6 col-sm-6 col-md-6">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    <img class="img-thumb-col{{$i}}-preview img-fluid"
                                        src="{{($rows->thumbnail!="")?asset($rows->thumbnail):'https://via.placeholder.com/135x75.png'}}"
                                        alt="preview">
                                </div>
                                <div class="form-group col-md-6">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $(".btn-thumb-col0").on("click",function(){
            selectFileWithCKFinder("thumb-col0",'.img-thumb-col0-preview');
        });
