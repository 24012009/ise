...
@section('content')
    {!! Form::open(array('url' =>url("administrator/pages/{$page_id}/slide"),'method'=>'POST','files' => true)) !!}
    <div class="row">
        <div class="col-md-8">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                {!! Form::text('slide_name', null, array('placeholder' => 'Name','class' =>'form-control form-control-flat')) !!}
                            </div>
                        </div>
                        <div class="col-xs-4 col-sm-4 col-md-4">
                            <div class="form-group">
                                <label>Slide title</label>
                                {!! Form::text('slide_title', null, array('placeholder' => 'Name','class' =>'form-control form-control-flat')) !!}
                            </div>
                        </div>
                        <div class="col-xs-4 col-sm-4 col-md-4">
                            <div class="form-group">
                                <label>Position</label>
                                {!! Form::select('sl_position', ['left'=>'Left','right'=>'right','Center'],null, array('class' =>'form-control form-control-flat')) !!}
                            </div>
                        </div>
                        <div class="col-xs-4 col-sm-4 col-md-4">
                            <div class="form-group">
                                <label>Custom Field</label>
                                {!! Form::text('custom_field', null, array('placeholder' => 'Custom Field','class' =>'form-control form-control-flat')) !!}
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                <label>Content</label>
                                {!! Form::textarea('content', null, array('class' =>'form-control form-control-flat basictools','id'=>'content')) !!}
                            </div>
                        </div>
                    </div>
                </div>
