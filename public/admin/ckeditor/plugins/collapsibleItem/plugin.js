function getCollapsibleItem() {
    var collapsibleItem =
        '<div class="according-custom mb-1">' +
        '<div class="card-header collapsible-item" id="collapbsible-1" data-toggle="collapse" data-target="#collapse0" aria-controls="collapse0" aria-expanded="true">' +
        ...
        '           <a class="collapsed collapsible-item-title-link-icon pull-right d-none" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseCollapbsible" aria-expanded="false" aria-controls="collapseCollapbsible"><span class="glyphicon glyphicon-chevron-down">&nbsp;</span></a>' +
        '           <a class="card-title collapsed collapsible-item-title-link" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseCollapbsible" aria-expanded="false" aria-controls="collapseCollapbsible"><span class="collapsible-item-title-link-text">Title Text</span></a>' +
        '       </h4>' +
        '   </div>' +
...
CKEDITOR.plugins.add('collapsibleItem', {
    ...
    onLoad: function () {
        CKEDITOR.addCss(
            ...
            '.collapsible-item::before {font-size:10px;color:#000;content: "tab"}' +
