...
@section('content')
{!! Form::open(array('route' =>['feature.store',$Pid],'method'=>'POST','files' => true)) !!}
<div class="row">
    <div class="col-md-8">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::text('feature_name', null, array('placeholder' => 'Title','class' =>'form-control form-control-flat')) !!}
                        </div>
                    </div>
                    <div class="col-xs-6 col-sm-6 col-md-6">
                        <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        {!! Form::textarea("details",null,array("class"=>'form-control form-control-flat basictools','id'=>'acticle','rows'=>5)) !!}
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="card-sub">
                            ...
                            <div class="form-group">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        @foreach($versions as $rows)
                                            <td>
                                                <input type="text" name="remark[]" class="form-control form-control-flat">
                        ...
                        <div id="collapseOne" class="collapse bg-white show " aria-labelledby="headingOne" data-parent="#accordionExample">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        {!! Form::text('is_order',$is_order, array('class' =>'form-control','required'=>'')) !!}
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="form-group col-md-12">
                                    <img
                                        ...
                                        src="https://via.placeholder.com/350x120.png"
                                        alt="preview">
                                </div>
                                <div class="form-group col-md-12">
                                    <div class="input-group mb-3">
                                        <input type="text" name="file_upload" value="" class="form-control" id="thumb-col2" aria-describedby="basic-addon3">
