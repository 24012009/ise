        ...
        <div class="container py-5">
            <div class="row">
                <div class="col-lg-12 col-md-12 pt-5">
                    <h3 class="text-center">QuickBooks Online Certified user</h3>
                </div>
                <div class="col-lg-6">
                    <h3>QuickBooks Setup And Maintenance</h3>
                    <ul>
                    ...
                    <ul>
                        ...
                        Removing list entries (including what QuickBooks does if an entry has a balance) Editing 
                        list entries
                        Merging list entries (including the basic rules of what can and can’t be merged)
                        Which names MUST appear on which forms (i.e. which names are required on specific 	
                        transactions otherwise QuickBooks will NOT save the transaction)
                    </ul>
                    <h3>Sales/Money-In</h3>
                    <ul>
                ...
                <div class="col-lg-6">
                    ...
                    <ul>
                        ...
                        <li>How to enter a Journal Entry if asked to do so by an accountant (students do not need to </li>
                        <li>understand how to determine which accounts to debit or credit)</li>
