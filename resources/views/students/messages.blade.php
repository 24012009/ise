                                    ...
                                    <li>
                                        <a href="javascript:void(0);" class="btn-active">
                                            <div class="form-group form-check">
                                                <input type="checkbox" name="chName[]" class="form-check-input" id="exampleCheck{{$rows->notification_id}}" value="{{$rows->notification_id}}"/>
                                                <label class="form-check-label" for="exampleCheck{{$rows->notification_id}}">{{$rows->subject}} ( {{date("d/m/Y",strtotime($rows->date))}} )</label>
                                            </div>
                                        </a>
...
@section("script")
    <script type="text/javascript">
        $("a.btn-active").on("click",function(){
            $this=$(this);
            is_checked=$this.find("input[type=checkbox]").is(":checked");
            $id=$this.find("input[type=checkbox]").val();
            if(is_checked==true){
                $this.parent().find(".coll").empty().hide();
                $this.find("input[type=checkbox]").prop("checked",false);
            }else{
                $this.parent().find(".coll").load("/student/dashboard/messages/"+$id,function(){
