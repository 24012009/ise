...
@section('content')
    {!! Form::model($compare, ['method' => 'PATCH','route' => ['compare.update', $compare->compare_id],'files' => true]) !!}
    <div class="row">
        <div class="col-md-8">
                            ...
                            <div id="collapseOne" class="collapse bg-white show " aria-labelledby="headingOne" data-parent="#accordionExample">
                                <div class="card-body">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            {!! Form::select("is_active",['Private','Publish'],null,['class'=>'form-control']) !!}
...
{{--                                            </select>--}}
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            {!! Form::text('order_by',$compare->is_order, array('class' =>'form-control','required'=>'')) !!}
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <img
                                            ...
                                            src="{{!empty($compare->image_compare)?asset($compare->image_compare):"https://via.placeholder.com/462x308.png"}}"
                                            alt="preview">
                                        <div class="input-file input-file-image mt-2">
                                            <input type="text" value="{{$compare->image_compare}}" class="form-control form-control-file" id="thumb-col1" name="image_compare" accept="image/*">
