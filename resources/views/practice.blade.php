    ...
    <div id="main-slide" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <picture>
                    <source srcset="{{asset("/uploads/images/slideshow/banner1.jpg")}}" media="(min-width: 1400px)">
                    <source srcset="{{asset("/uploads/images/slideshow/banner1.jpg")}}" media="(min-width: 769px)">
                    <source srcset="{{asset("/uploads/images/slideshow/banner1.jpg")}}" media="(min-width: 577px)">
                    <img srcset="{{asset("/uploads/images/slideshow/banner1.jpg")}}" alt="responsive image"
...
@section("content")
    <div class="container py-5">
        <div class="row">
            <div class="col-lg-6 col-md-6 pt-5">
                <img src="{{asset("/uploads/images/section/practice-tests-for-qb-certified-user-exam.png")}}" class="img-fluid" alt="">
            </div>
            <div class="col-lg-6 col-md-6 pt-5">
                <h3 class="font-md-11">Practice tests​ for QuickBooks Certified User Exam</h3>
                <p class="font-md-6">
                    These performance-based assessment and test preparation tools help individuals achieve QuickBooks Certified User. Many of your students will be anxious to assess their knowledge of applications prior to taking the certification exams. Additionally, we recognize the need for educators to properly assess an individual’s knowledge. To this end, Certiport has partnered with GMetrix to deliver industry-leading practice tests. These tests, with included reporting and insight features, ensure your students are adequately prepared to take their certification exam.
                </p>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="practice-ul">
                        <h3>Why GMetrix practice tests? </h3>
                        <ul>
                ...
                <div class="col-md-4 d-flex align-items-center">
                    ...
                    <img src="{{asset("/uploads/images/section/video.png")}}" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
    <div class="container-fluid bg-white">
        <div class="container container-gmetrix py-5">
            <div class="row">
                <div class="col-md-8">
                    <h3>GMetrix practice tests are customizable</h3>

                    GMetrix practice tests are customizable, allowing you to create a highly-effective environment conducive to student-centered
                    learning. GMetrix practice tests offer two different modes:
                ...
                <div class="col-md-4">
                    <img src="{{asset("/uploads/images/section/gmatrix.png")}}" class="img-fluid"/>
                </div>
            </div>
        </div>
    </div>
