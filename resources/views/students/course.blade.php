        ...
        <div class="container" style="margin-top: 70px;">
            <div class="row">
                ...
                <div class="col-md-9 d-flex justify-content-center align-items-center">
                    @yield("dashboardStudent")
                    @if($mycourse->count()>0)
                        <h4>My Course</h4>
                        <div class="row">
                            @foreach($mycourse as $rows)
                            <div class="col-md-4">
                                <div class="card">
                                    <img src="..." class="card-img-top" alt="...">
                                    <div class="card-body">
                                        <h5 class="card-title">title Course</h5>
                                        <p class="card-text">with Price</p>
                                        <a href="#" class="btn btn-primary btn-print">Print Invoice</a>
                                    </div>
                                </div>
                            </div>
                            @endforeach
                    ...
                    @else
                        <h4 class="text-center">Empty Course</h4>
                    @endif
                </div>
            </div>
        </div>
