...
@section('content')
    {!! Form::model($version, ['method' => 'PATCH','route' => ['version.update',$Pid,$id],'files' => true]) !!}
{{--    {!! Form::open(array("route"=>['version.update',$Pid,$id],'method' => 'PATCH','files' => true)) !!}--}}
    <div class="row">
        <div class="col-md-8">
                    ...
                    <div class="row">
                        <div class="col-xs-4 col-sm-4 col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::text('version_name', $version->versions, array('placeholder' => 'Name','class' =>'form-control form-control-flat')) !!}
                            </div>
                        </div>
                        <div class="col-xs-4 col-sm-4 col-md-4">
                            <div class="form-group">
                        ...
                        <div class="col-xs-4 col-sm-4 col-md-4">
                            <div class="form-group">
                                <label>Class</label>
                                {!! Form::text('class_css', $version->class_css, array('placeholder' => 'class name','class' =>'form-control form-control-flat')) !!}
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                <label>Custom Field</label>
                                {!! Form::textarea('custom_field', $version->custom_field, ['class' => 'form-control basictools','id'=>'col01', 'rows' =>5]) !!}
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="is_active" class="form-control">
                                                <option value="1" {{($version->is_active==1)?"selected":""}}>Active</option>
                                                <option value="0" {{($version->is_active==0)?"selected":""}}>Inactive</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            {!! Form::text('is_order',$version->is_order, array('class' =>'form-control','required'=>'')) !!}
                                        </div>
                                    </div>
                                </div>
                            </div>
