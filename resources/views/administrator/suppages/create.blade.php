...
@section('content')
{!! Form::open(array('route' =>'subpages.store','method'=>'POST','files' => true)) !!}
<div class="row">
    <div class="col-md-8">
                ...
                <div class="row">
                    <div class="col-xs-6 col-sm-6 col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::select('sl_pages',$pages,null, array('class' =>'form-control')) !!}
                        </div>
                    </div>
                    <div class="col-xs-6 col-sm-6 col-md-6">
                        <div class="form-group">
                            <label>Sub page title</label>
                            {!! Form::text('title_subpage', null, array('placeholder' => 'Name','class' =>'form-control')) !!}
                        </div>
                    </div>
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6">
                        <div class="form-group">
                            <label>Links</label>
                            {!! Form::text('links', null, array('placeholder' => 'URL','class' =>'form-control')) !!}
                        </div>
                    </div>
                </div>
            </div>
